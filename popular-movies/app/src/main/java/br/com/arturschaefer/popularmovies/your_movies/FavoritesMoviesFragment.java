 ...
 */
public class FavoritesMoviesFragment extends Fragment implements MovieAdapter.CallbackInterface {
    ...
    public static FavoritesMoviesFragment newInstance(String param1, String param2) {
    ...
    public void getFavorites() {
        if (MoviesApplication.favoritesMovies == null ||
                MoviesApplication.favoritesMovies.size() == 0) {
            showHideList(true);
            textEmpty.setText("You don't register any movie watched");
        } else {
            showHideList(false);
            movieAdapter.newListMovies(MoviesApplication.favoritesMovies);
        }
    }
